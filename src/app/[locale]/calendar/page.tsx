          ...
          <div className="card-classic p-4">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              <div>
                ...
                <p className="text-stone-400 text-xs mt-0.5">Wedding, Engagement</p>
                <p className="text-stone-400 text-xs">Свадьба, Помолвка</p>
              </div>
              <div>
                <p className="text-stone-400 text-xs">Unsuitable 忌</p>
                <p className="text-stone-600">词讼、安葬</p>
                <p className="text-stone-400 text-xs mt-0.5">Litigation, Funeral</p>
                <p className="text-stone-400 text-xs">Суд, Похороны</p>
              </div>
            </div>
            <p className="mt-2 text-xs text-accent">
              Auspicious gods: 天德、月德
              <span className="text-stone-400 block">Heavenly Virtue, Lunar Virtue / Небесная Добродетель, Лунная Добродетель</span>
            </p>
          </div>
