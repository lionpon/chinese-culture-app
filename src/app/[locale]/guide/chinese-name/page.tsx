...
const CONTENT: Record<string, {
  ...
  ru: {
    ...
    faqs: [
      ...
      { q: "Сколько стоит создание имени?", a: "Платите сколько хотите — от $5.99. Ваш платеж поддерживает развитие приложения, а не покупка услуги." },
    ],
    cta: "Создать Китайское Имя — от $5.99",
  ...
  ja: {
    ...
    faqs: [
      ...
      { q: "料金はいくらですか？", a: "お気持ちで — $5.99から。サービスの購入ではなく、デジタルコンテンツの購入です。" },
    ],
    cta: "あなたの中国名を作成 — $5.99から",
