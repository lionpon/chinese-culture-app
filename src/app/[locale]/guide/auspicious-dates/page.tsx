...
const CONTENT: Record<string, {
  ...
  ru: {
    ...
    faqs: [
      ...
      { q: "Это платно?", a: "Платите сколько хотите — от $5.99. Первое чтение бесплатно. Ваш платеж поддерживает развитие сервиса." },
    ],
    cta: "Найти Благоприятную Дату — от $5.99",
  ...
  ja: {
    ...
    faqs: [
      ...
      { q: "有料ですか？", a: "お気持ちで — $5.99から。最初の1回は無料です。デジタルコンテンツの購入です。" },
    ],
    cta: "吉日を探す — $5.99から",
