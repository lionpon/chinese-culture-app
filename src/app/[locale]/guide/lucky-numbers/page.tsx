...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title: c.ogTitle, description: c.ogDesc },
        alternates: {
      languages: {
        en: "https://www.culture-of-china.com/guide/lucky-numbers",
        ru: "https://www.culture-of-china.com/ru/guide/lucky-numbers",
        ja: "https://www.culture-of-china.com/ja/guide/lucky-numbers",
      },
    },
      robots: "index, follow",
  };
