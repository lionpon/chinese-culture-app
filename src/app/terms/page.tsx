export default function TermsPage() {
  return (
    <div className="max-w-2xl mx-auto prose prose-sm prose-stone">
      <h1 className="text-2xl font-bold" style={{ color: "var(--accent)" }}>Terms of Service</h1>
      ...
      <p>
        ...
        algorithmic principles. The Chinese name suggestions, auspicious date selections, and I Ching
        divination readings are generated algorithmically by reference to classical Chinese texts and
        traditional methods. This service is intended for <strong>entertainment and cultural appreciation
        purposes only</strong>. It does not provide, and should not be relied upon as, professional advice
        of any kind — legal, medical, financial, psychological, or otherwise. No client-professional
        relationship is established through the use of this service.
      </p>
      ...
      <h2>3. Payment</h2>
      <p>
        Each reading requires a payment of USD $1.00, processed securely through Lemon Squeezy.
        <strong>This payment is a voluntary contribution toward the hosting, development, and ongoing
        maintenance of this application.</strong> It is not a purchase of advice, a consultation fee,
        or compensation for any particular outcome, and it does not create any advisory, fiduciary,
        or client-professional relationship. You are supporting the continued availability of this
        cultural resource, and in return you receive an algorithmically generated interpretation
        as a token of appreciation. All payments are final. If you experience a technical issue
        preventing result delivery, please contact us for resolution.
      </p>
