...
export const hexagrams: Hexagram[] = [
  // 1. 乾 (Qián) - The Creative
  {
    ...
    descriptionEn: "The Creative represents the primal power of Heaven. All six lines are yang, signifying pure creative energy at its fullest. It marks a time of great potential and strong leadership — take the initiative and act with persistence.",
    lines: [
  ...
  // 6. 讼 (Sòng) - Conflict
  {
    ...
    lines: [
      ...
      { position: 5, text: "讼，元吉。", textEn: "To contend before him brings supreme good fortune.", isYang: true },
  ...
  // 8. 比 (Bǐ) - Holding Together
  {
    ...
    lines: [
      ...
      { position: 5, text: "显比，王用三驱，失前禽。邑人不诫，吉。", textEn: "Manifestation of holding together. The king hunts on three sides only, letting the game escape forward. The townspeople need no warning. Good fortune.", isYang: true },
  ...
  // 9. 小畜 (Xiǎo Chù) - The Taming Power of the Small
  {
    ...
    lines: [
      ...
      { position: 3, text: "舆说辐，夫妻反目。", textEn: "The spokes burst from the wagon wheel. Husband and wife turn against each other.", isYang: true },
  ...
  // 14. 大有 (Dà Yǒu) - Great Possession
  {
    ...
    lines: [
      { position: 1, text: "无交害，匪咎，艰则无咎。", textEn: "Having no connection with what is harmful brings no blame. Through hardship comes no blame.", isYang: true },
  ...
  // 15. 谦 (Qiān) - Modesty
  {
    ...
    descriptionEn: "True greatness lies hidden within. Modesty wins respect and lets matters come to completion naturally.",
    lines: [
  ...
  // 16. 豫 (Yù) - Enthusiasm
  {
    ...
    lines: [
      ...
      { position: 2, text: "介于石，不终日，贞吉。", textEn: "Firm as a rock — he does not let a whole day pass. Perseverance brings good fortune.", isYang: false },
      ...
      { position: 5, text: "贞疾，恒不死。", textEn: "Chronically ill, yet he does not die.", isYang: false },
  ...
  // 51. 震 (Zhèn) - The Arousing
  {
    ...
    lines: [
      ...
      { position: 2, text: "震来厉，亿丧贝，跻于九陵，勿逐，七日得。", textEn: "The shock arrives, bringing danger. A hundred thousand cowries lost. Climb the nine hills. Do not pursue. After seven days you will get them back.", isYang: false },
  ...
  // 64. 未济 (Wèi Jì) - Before Completion
  {
    ...
    lines: [
      ...
      { position: 4, text: "贞吉，悔亡，震用伐鬼方，三年有赏于大国。", textEn: "Perseverance brings good fortune. Remorse disappears. He uses the shock to attack the Demon Region — for three years the great kingdom rewards him.", isYang: true },
...
const midHexagrams: Hexagram[] = [
  ...
  { id: 28, nameZh: "泽风大过", nameEn: "Great Excess", pinyin: "Zé Fēng Dà Guò", upperTrigram: "兑", lowerTrigram: "巽", judgment: "栋桡，利有攸往，亨。", judgmentEn: "The ridgepole sags. It furthers one to undertake something. Success.", description: "Lake over Wind — great excess. The center cannot bear the weight. Bold action in crisis is needed.", descriptionEn: "The ridgepole sags under too much weight. Bold, unconventional action is required.", lines: [] },
  { id: 29, nameZh: "坎为水", nameEn: "The Abysmal", pinyin: "Kǎn Wéi Shuǐ", upperTrigram: "坎", lowerTrigram: "坎", judgment: "习坎，有孚，维心亨，行有尚。", judgmentEn: "Repeated danger. With sincerity, the heart penetrates. Action is esteemed.", description: "Water doubled — the abyss, danger. Face danger with sincerity and inner truth. Flow like water around obstacles.", descriptionEn: "Danger upon danger. Face it with sincerity and flow around obstacles the way water does.", lines: [] },
