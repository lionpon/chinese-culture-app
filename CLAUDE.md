...
- **P0 已完成：起名页添加免费八字五行预览** — 用户填写出生日期后即时显示日主、五行平衡条、喜用神
- **P2 已完成：导航栏加入免费工具入口 + 首页周运势邮件订阅**
  - Desktop nav: Daily I Ching (金色) + Free Tools 下拉菜单
  - Mobile nav: Daily I Ching + 免费工具分组
  - 首页 Weekly Fortune 邮件订阅 CTA
- 待：P1（择日/占卜免费预览 + 世界杯 CTA）
- 待 PayPal 企业审批
